...
Each zosh node wraps the following data sources:
...
It's currently okay using third-party API to fetch data sources since we'll submit our results of the data on chain and get validated by other nodes finally.
